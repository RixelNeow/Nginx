...
echo "[Git] Cloning default repository 'https://github.com/RixelNeow/Nginx' into temporary directory."
git clone https://github.com/RixelNeow/Nginx /mnt/server/gtemp > /dev/null 2>&1 && echo "[Git] Repository cloned successfully." || { echo "[Git] Error: Default repository clone failed."; exit 21; }
